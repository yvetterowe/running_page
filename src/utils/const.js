// const
const MAPBOX_TOKEN =
  'pk.eyJ1IjoieXZldHRlcm93ZSIsImEiOiJjbGZ0NDQyeWswYzh6M3ZyeWt5aTNhOHI4In0.6zCzKvjZhXBcndnsu7hQGg';
...
const nike = 'rgb(255,182,193)'; // light pink - softer and more mellow. Also change in src/styles/variables.scss

// If your map has an offset please change this line
// issues #92 and #198
export const NEED_FIX_MAP = false;
export const MAIN_COLOR = nike;
export const PROVINCE_FILL_COLOR = '#FFB6C1'; // light pink for map provinces
